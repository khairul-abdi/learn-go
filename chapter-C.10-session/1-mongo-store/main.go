...
func newMongoStore() *mongostore.MongoStore {
	// mgoSession, err := mgo.Dial("localhost:27123") //Original
	// mgoSession, err := mgo.Dial("localhost:27017") //port sesuai dengan yang di punya laptop ini
	mgoSession, err := mgo.Dial("mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass&ssl=false")
	if err != nil {
